...
class VacationRequestController {
	...
	private static final String FILE_NAME = "vacationRequest"; // this is the file name to define the process flow
			...
			if (params.version) {
				...
				if (vacationRequestInstance.version > version) {
					...
					vacationRequestInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [
						message(code: 'vacationRequest.label', default: 'VacationRequest')] as Object[], "Another user has updated this VacationRequest while you were editing")
